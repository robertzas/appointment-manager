...
ALTER TABLE CANCELLATION ADD CONSTRAINT CANCELLATION_PK PRIMARY KEY ( RESERVATION_ID ) ;
...
ALTER TABLE EMPLOYEE_SERVICE ADD CONSTRAINT EMPLOYEE_SERVICE_PK PRIMARY KEY ( EMPLOYEE_ID, SERVICE_ID ) ;
...
CREATE TABLE RESERVATION
  (
    ...
    PERSON_FK                    NUMBER (19) ,
    EMPLOYEE_SERVICE_EMPLOYEE_FK NUMBER (19) NOT NULL ,
    EMPLOYEE_SERVICE_SERVICE_FK  NUMBER (19) NOT NULL
  ) ;
...
ALTER TABLE SCHEDULE ADD CONSTRAINT SCHEDULE_PK PRIMARY KEY ( DAY_OF_WEEK, EMPLOYEE_ID ) ;
...
ALTER TABLE RESERVATION ADD CONSTRAINT RESERVATION_EMPL_SERV_FK FOREIGN KEY ( EMPLOYEE_SERVICE_EMPLOYEE_FK, EMPLOYEE_SERVICE_SERVICE_FK ) REFERENCES EMPLOYEE_SERVICE ( EMPLOYEE_ID, SERVICE_ID ) ;
